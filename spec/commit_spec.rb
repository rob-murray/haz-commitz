...
describe HazCommitz::Commit do

    describe "creating instance" do

        context "with all valid data" do

            subject(:commit) { HazCommitz::Commit.new("abcdefg", "joe bloggs", DateTime.now, "a brilliant fix") }
        ...
        context "without commit message" do
            ...
            subject(:commit) { HazCommitz::Commit.new("abcdefg", "joe bloggs", DateTime.now) }
